        ...
        new Character
        {
            ...
            [
                ...
                new Weapon
                {
                    ...
                    Skills = new SkillSet
                    {
                        PassiveName = "Carica statica",
                        PassiveDescription = "Eseguire un attacco normale infligge elettromagnete al nemico per 40 sec. Aumenta il danno del 20% quando una torretta elettrica attacca un nemico afflitto da elettromagnete ",
                        PassiveStatusDescription = "Elettromagnete: riduece la resistenza critica d3l 10%",
                        AttackName = "Bomba frutta",
                        AttackDescription = "Infligge un danno pari ad un 75% dell'attacco, 1° hit: 11%, 2° hit: 12%, 3° hit: 19%, 4° hit: 33%",
                        CountdownSpecial = 8.4,// controllare in game
                        SpecialName = "Risveglio elettrizante",
                        SpecialDescription = "Aumenta il danno critico degli alleati del 15% per 40 sec. Usare la skill su una torretta elettrica ne aumenta lla veloctià di attacco per 10 sec.",
                        SpecialStatusDescription = "",
                        CountdownNormal = 12,
                        NormalName = "Evoca torretta elettrica",
                        NormalDescription = "Evoca una torretta elettrica per 15 sec, infliggi un danno pari ad un 3% dell'attacco ogni 1 sec. Ogni 5 colpi che compie la torretta elettrica, applica carica elettrica agli alleati nel range per 40 sec. (Massimo: 20 volte)",
                        NormalStatusDescription = "Carica elettrica: aumenta il danno critico del 5% e la possibilità di critico del 2%",
                        TagName = "Arriva Daisy",
                        TagDescription = "infligge danni pari a un 54% dell'attacco",
                        TagStatusDescription = "Energia demoniaca: infligge danni pari a un 120% dell'attacco quando viene rimosso.",
                        CountdownUltimate = 12,
                        UsageMagicUltimate = 2,
                        UltimateName = "Sbarramento di frutta",
                        UltimateDescription = "Infligge danni pari a un 178% dell'attacco e diminuisce la difesa critica del 30%",
                        UltimateStatusDescription = ""
                    }
                },
                new Weapon
                {
                    ...
                    {
                        PassiveCountDOwn = 20,
                        PassiveName = "Ragazza anticonformista",
                        PassiveDescription = "Infliggi semi tempestosi per 20 sec ogni volta che un attacco alleato risulta in un colpo critico.",
                        PassiveStatusDescription = "Semi tempestosi: Infliggi un danno addizionale pari ad un 80% dell'attacco e riduci la difesa del vento del 5% (Massimo: 20%) per 20 secondi quando si subisce un colpo critico l'effetto viene rimosso",
                        AttackName = "Comando delle fate",
                        AttackDescription = "infligge danni pari al 77% dell'attacco, 1° hit: 11%, 2° hit: 12%, 3° hit: 20%, 4° hit: 34%",
                        CountdownSpecial = 16.1,
                        SpecialName = "Frutto flash",
                        SpecialDescription = "Infligge danni pari a un 11% dell'attacco ai nemici vicini ogni 0.8 sec e aumenta la possibilità di critico di tutti gli alleati del 5% per 40 sec mentre la posizione viene mantenuta (Massimo: 4 volte). L'attacco finale infligge un danno pari ad un 32% dell'attacco e infligge stordimento per 4 sec",
                        SpecialStatusDescription = "",
                        CountdownNormal = 18.2, 
                        NormalName = "Seme bomba",
                        NormalDescription = "Infligge danni pari a un 106% dell'attacco, ogni colpo riduce la resistenza critica del nemico del 6% per 40 sec (Massimo: 4 volte). Colpo critico garantito contro i nemici storditi",
                        TagName = "Arriva Daisy",
                        TagDescription = "infligge danni pari a un 59% dell'attacco.",
                        TagStatusDescription = "",
                        CountdownUltimate = 10,
                        UsageMagicUltimate = 3,
                        UltimateName = "Incensiere strano",
                        UltimateDescription = "Per 10 sec, i nemici nel range hanno la loro resistenza al vento diminuita del 20% e il rateo di blocco del 30%, diventano afflitti da semi tempestosi per 20 sec ogni sec e prendono danno pari ad un 19% dell'attaco. Ogni colpo critico su un nemico nel range diminuisce il cooldown di semi tempestosi di 1 sec.",
                        UltimateStatusDescription = "Semi tempestosi: Infliggi un danno addizionale pari ad un 80% dell'attacco e riduci la difesa del vento del 5% (Massimo: 20%) per 20 secondi quando si subisce un colpo critico l'effetto viene rimosso"
                    }
                }
            ]
        },
